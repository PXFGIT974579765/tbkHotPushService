...
<html>
  ...
  <link rel="stylesheet" type="text/css"href="<%=basePath%>css/queryOrder.css" />
   <base href="<%=basePath%>">
...
<!-- 上半部分 -->
   <div class="content-up">
      ...
      <input type="hidden" value="${isSelf }" name="isSelf">
       <div class="col">
          <span>订单名:</span>
          <input name="orderName" id="orderName" value="官渡区王先生" style="color:grey">
      </div>
      <div class="col">
          <span>业主姓名:</span>
          <input name="owner.ownerName" id="owner.ownerName">
      </div>
      <div class="col">
          <span>业主地址:</span>
      ...
      <div class="col">
          <span>业主电话:</span>
          <input name="owner.ownerPhone" id="owner.ownerPhone">
      </div>
      <div class="col">
          <span>建筑面积:</span>
