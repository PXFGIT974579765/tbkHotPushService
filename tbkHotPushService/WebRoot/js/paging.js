	...
	Paging.prototype = {
		...
		bindEvent: function() {
			...
			this.container.on('click', 'li.js-page-action,li.ui-pager', function(e) {
				if ($(this).hasClass('ui-pager-disabled') || $(this).hasClass('pfocus')) {
					return false;
				}
		...
		format: function() {
			...
			this.container.find('li[data-page="' + this.current + '"]').addClass('pfocus').siblings().removeClass('pfocus');
